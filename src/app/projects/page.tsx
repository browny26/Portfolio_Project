    ...
    <div className="bg-[#f5f3ef] min-h-screen">
      ...
      <main>
        ...
        >
          ...
          <div className="overflow-clip">
            <p className="reveal-line block mt-8 text-[0.9rem] leading-[1.7] text-[#8c8680] max-w-[36rem]">
              A selection of projects spanning web development, UI/UX design and
              mobile applications.
            </p>
          </div>
        </div>
        ...
        <div ref={gridRef} className="section pt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-14">
            {projects.map((project) => (
              <article key={project.slug} className="proj-card group opacity-0">
                {/* Image */}
                <div
                  className="relative overflow-hidden mb-5 bg-[#e8e4dd]"
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-[rgba(26,26,26,0.55)]">
                    <span className="label text-[#f5f3ef]">View project</span>
                  </div>
                </div>
                ...
                >
                  ...
                  <span className="label shrink-0 mt-0.5">{project.year}</span>
                </div>

                {/* Description */}
                <p
                  className="text-[0.85rem] leading-[1.7] text-[#8c8680] mb-4"
