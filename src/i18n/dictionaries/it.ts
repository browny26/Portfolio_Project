  ...
  process: [
    {
      ...
      image: {
        ...
        alt: "Le impostazioni di Newmann: tema, lingua, firma email, etichette Newmann e ruolo dell'utente",
        aspect: "16/10",
      },
    },
    {
      ...
      image: {
        ...
        alt: "La modifica di una bozza in Newmann: la bozza originale accanto alla nuova versione, con il campo per chiedere all'AI di rigenerarla",
        aspect: "16/10",
      },
    },
    {
    ...
    },
    {
      ...
      image: {
        ...
        alt: "L'elenco delle etichette in Newmann, con la scelta sulle bozze automatiche e le regole collegate a ogni etichetta",
        aspect: "16/10",
      },
    },
  ],
  ...
  gallery: [
    {
      ...
      alt: "La pagina di accesso di Newmann, con login tramite Google o Microsoft",
      aspect: "16/10",
    },
    {
      src: "/imgs/newmann-dashboard-overview.webp",
      alt: "La dashboard di Newmann con etichette, bozze automatiche e regole attive",
      aspect: "16/10",
    },
    {
...
const atlasCaseStudy: CaseStudy = {
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: "La pagina Services di Atlas, con il titolo Adventure in grande e una griglia di fotografie di paesaggi",
      aspect: "16/10",
    },
    {
      src: "/imgs/atlas-adventure.webp",
      alt: "La pagina Adventure di Atlas, con il form per generare un itinerario da destinazione, giorni, budget e interessi",
      aspect: "16/10",
    },
  ],
  learnings: [
